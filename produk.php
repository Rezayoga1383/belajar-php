...
$dataapi = @file_get_contents($api, false, stream_context_create($option));
    ...
    if (isset($data) && is_array($data['products'])) {
?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container mt-3">
        ...
        <p>Berikut Ini Adalah Daftar Produk Yang Kami Sediakan</p>
        <div class="row">
            <?php foreach ($data['products'] as $product) { ?>
                <div class="col-md-3 mb-3">
                    <div class="card" style="width: 100%; height: 400px;">
                        <img class="card-img-top" src="<?= $product['thumbnail']; ?>" alt="Card image" style="object-fit: cover; height: 200px; width: 100%;">
                        <div class="card-body">
